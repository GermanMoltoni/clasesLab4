...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-08-2017 a las 03:06:36
...
INSERT INTO `usuario` (`id`, `nombre`, `apellido`, `mail`, `usuario`, `password`, `habilitado`) VALUES
(1, 'german', 'german', 'german@german', 'germanMM', '123', 1),
(2, 'Juan', 'Gonzalez', 'juan@juan', 'juanG', '123', 0);
